...
3. AI and Heuristics
The project's AI architecture was designed to simulate an opponent with tactical knowledge adapted to the level chosen in the main menu. When in doubt, two thoughts occurred to me: how to assign values to each move and how to measure it by its own defined level?

To solve the challenge of how to "measure the best move," a Value Heuristic system and the Strategy Pattern were implemented.
